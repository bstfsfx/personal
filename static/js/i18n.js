...
// Supports: English (en), Traditional Chinese (zh-TW), Japanese (ja)
...
const translations = {
    en: {
        ...
        "project-travel-title": "Travel & Airport Transfer Platform",
        "project-travel-desc": "Automated airport, HSR, and cross-city chauffeur transfer platform for Taiwan travelers featuring an interactive quote calculator, vehicle recommendations based on passenger and luggage requirements, 24-hour booking workflows, and LINE-based customer consultation.",
        "project-survey-title": "Survey & Engineering Measurement",
        "project-survey-desc": "Professional land and construction surveying platform featuring systematic measurement service workflows, boundary and topographic survey offerings, RTK/GNSS and UAV equipment integration, a structured 6-step project delivery process, and clear CAD data reporting.",
        "project-social-title": "Family & Student Support Services",
        "project-social-desc": "Social work consultation platform for parents, students, and schools covering school adjustment, parent-child communication, and academic pressure, with a structured 4-step intake workflow, parent education articles, school partnership programs, and booking-based counseling services.",
    ...
    "zh-TW": {
        ...
        "project-travel-title": "交通與機場接送平台",
        "project-travel-desc": "為台灣旅客打造的機場、高鐵與跨城專車接送平台，具備互動式報價計算、依人數與行李需求推薦車型、24 小時預約流程，以及 LINE 客戶諮詢功能，自動化整體接送安排。",
        "project-survey-title": "土地測量與工程測量平台",
        "project-survey-desc": "專業土地與工程測量服務平台，具備系統化的測量作業流程、界址與地形測量服務、RTK/GNSS 與 UAV 航測設備整合、六步驟專案交付流程，以及清楚完整的 CAD 成果資料。",
        "project-social-title": "家庭與學生支持服務",
        "project-social-desc": "服務家長、學生與學校的社會工作諮詢平台，涵蓋校園適應、親子溝通與學習壓力等議題，具備四步驟諮詢流程、家長教育專欄、學校合作方案，以及預約制的專業支持服務。",
    ...
    "ja": {
        ...
        "project-travel-title": "空港送迎プラットフォーム",
        "project-travel-desc": "台湾の旅行者向け空港・新幹線・都市間送迎プラットフォーム。インタラクティブな見積もり計算、人数と荷物に応じた車両提案、24時間予約ワークフロー、LINEでの顧客相談を備え、送迎手配を自動化します。",
        "project-survey-title": "測量・建設計測",
        "project-survey-desc": "土地・建設測量の専門プラットフォーム。体系的で測量業務ワークフロー、境界・地形測量、RTK/GNSSやUAVを活用した設備統合、6ステップのプロジェクト納品、明確なCADデータ報告を備えています。",
        "project-social-title": "家庭・学生サポートサービス",
        "project-social-desc": "保護者・生徒・学校向けの社会工作相談プラットフォーム。学校適応、親子コミュニケーション、学習ストレスに対応し、4ステップの相談導線、親教育コラム、スクール連携プログラム、予約制のカウンセリングサービスを備えています。",
